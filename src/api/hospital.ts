...
import type { HospitalDetail,DeparmentResponseData,LoginData,UserLoginResponseData,WXLoginResponseData,HospitalWordData,DoctorResponseData,UserResponseData,DoctorInfoData } from "./hospitaltype";
//枚举请求地址
enum API{
    HOSPITALDETAIL_URL='/hosp/hospital/',
    //获取某个医院的科室数据
    HOPITALDEPARTMENT_URL='/hosp/hospital/department/',
    //获取验证码接口
...
//获取医院科室的接口
export const reqHospitalDeparment=(hoscode:string)=>request.get<any,DeparmentResponseData>(API.HOPITALDEPARTMENT_URL+hoscode)
//获取短信验证码的接口
